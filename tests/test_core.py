...
class TestUserModel:
    ...
    def test_user_defaults(self):
        ...
        u = User(username="testuser", password=b"hashed")
        assert u.email is None
        assert u.is_active is True or u.is_active is None
...
class TestProductModel:
    def test_product_creation(self):
        ...
        p = Product(
            name="Test", description="Desc", price=100, url="http://example.com"
        )
        assert p.name == "Test"
