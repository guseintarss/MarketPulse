    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fafafa' }}>
      <form onSubmit={handleSubmit} style={{ background: 'white', padding: 40, borderRadius: 16, boxShadow: '0 4px 24px rgba(108,58,237,0.1)', width: 400, maxWidth: '90%' }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <h2 style={{ marginTop: 16, fontSize: '1.5rem' }}>Регистрация</h2>
        </div>
        ...
        <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center' }}>Зарегистрироваться</button>
        <p style={{ textAlign: 'center', marginTop: 16, fontSize: '0.9rem', color: '#7c7c9a' }}>
          Уже есть аккаунт? <Link to="/login" style={{ color: '#6C3AED', fontWeight: 600 }}>Войти</Link>
        </p>
      </form>
    </div>
  );
